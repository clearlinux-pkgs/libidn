...
Version  : 1.42
Release  : 29
URL      : https://mirrors.kernel.org/gnu/libidn/libidn-1.42.tar.gz
Source0  : https://mirrors.kernel.org/gnu/libidn/libidn-1.42.tar.gz
Source1  : https://mirrors.kernel.org/gnu/libidn/libidn-1.42.tar.gz.sig
...
%setup -q -n libidn-1.42
cd %{_builddir}/libidn-1.42
pushd ..
cp -a libidn-1.42 build32
popd
pushd ..
cp -a libidn-1.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720051502
...
cp %{_builddir}/libidn-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libidn/9073f4cea0719691d9bffa999213e60e904afd30 || :
cp %{_builddir}/libidn-%{version}/COPYING.LESSERv2 %{buildroot}/usr/share/package-licenses/libidn/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/libidn-%{version}/COPYING.LESSERv3 %{buildroot}/usr/share/package-licenses/libidn/f45ee1c765646813b442ca58de72e20a64a7ddba || :
cp %{_builddir}/libidn-%{version}/COPYINGv2 %{buildroot}/usr/share/package-licenses/libidn/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/libidn-%{version}/COPYINGv3 %{buildroot}/usr/share/package-licenses/libidn/e88f6aea9379eb98a7bbea965fc7127a64b41ad9 || :
cp %{_builddir}/libidn-%{version}/doc/specifications/COPYING.UCD %{buildroot}/usr/share/package-licenses/libidn/f13a577febd13d4323fb91f99615f194826511fd || :
cp %{_builddir}/libidn-%{version}/java/LICENSE-2.0.txt %{buildroot}/usr/share/package-licenses/libidn/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libidn.so.12.6.5
/usr/lib64/libidn.so.12
/usr/lib64/libidn.so.12.6.5

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libidn.so.12
/usr/lib32/libidn.so.12.6.5
